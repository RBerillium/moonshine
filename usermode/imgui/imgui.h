...
struct ImGuiTextFilter
{
    ...
    void                Backspace() { if (strlen(InputBuf) != 0) { InputBuf[strlen(InputBuf) - 1] = '\0'; Build(); } }
...
struct ImFontConfig
{
    ...
    int             OversampleH;            // 3        // Rasterize at higher quality for sub-pixel positioning. Note the difference between 2 and 3 is minimal so you can reduce this to 2 to save  Read https://github.com/nothings/stb/blob/master/tests/oversample/README.md for details.
